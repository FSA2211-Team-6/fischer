...
-- CreateIndex
CREATE UNIQUE INDEX "Expert_fischerId_topicId_key" ON "Expert"("fischerId", "topicId");
...
-- AddForeignKey
ALTER TABLE "ExpertCompliance" ADD CONSTRAINT "ExpertCompliance_fischerId_fkey" FOREIGN KEY ("fischerId") REFERENCES "User"("fischerId") ON DELETE CASCADE ON UPDATE CASCADE;
