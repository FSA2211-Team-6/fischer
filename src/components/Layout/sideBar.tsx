      ...
      <div className="h-full bg-white dark:bg-gray-700">
        ...
        <nav className="mt-6">
          <div>
            ...
            <SideBarItem name="Topics" link="/topics" viewbox="0 0 2048 1792">
        ...
        <Link href="/">
          <div className="flex items-center justify-start pt-6 ml-8">
            <p className="text-xl font-bold dark:text-white">Administrator</p>
          </div>
        </Link>
        <nav className="mt-6">
          <div>
            <SideBarItem name="Search Users" link="/users" viewbox="0 0 24 24">
              <path
            ...
            <SideBarItem
              ...
              link="/expertApplications"
              viewbox="0 0 1792 1792"
            >
              <path d="M1728 608v704q0 92-66 158t-158 66h-1216q-92 0-158-66t-66-158v-960q0-92 66-158t158-66h320q92 0 158 66t66 158v32h672q92 0 158 66t66 158z"></path>
            </SideBarItem>
            <SideBarItem
              name="Components for Devs"
              link="/badPosts"
